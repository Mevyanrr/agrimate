...
Future<double?> showRatingSheet(BuildContext context, {required Color accentColor}) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: RadialGradient(
                colors: [AppColors.goldStar.withOpacity(0.25), Colors.transparent],
              ),
            ),
            child: Icon(Icons.star_rounded, color: AppColors.goldStar, size: 44.sp),
          ),
          ...
          SizedBox(height: 4.h),
          Text('Bagaimana pengalaman transaksimu?',
              ...
              return GestureDetector(
                ...
                child: Padding(
                  ...
                  child: Icon(
                    Icons.star_rounded,
                    size: 40.sp,
                    color: isFilled ? AppColors.goldStar : AppColors.goldStarLight,
                  ),
                ),
              );
            }),
              ...
              child: OutlinedButton(
                onPressed: vm.isSubmitting
                    ...
                    : () async {
                        ...
                        if (success && context.mounted) {
                          ...
                          await showRatingSuccessSheet(context);
                          if (context.mounted) {
                ...
                child: vm.isSubmitting
                    ? SizedBox(
                        ...
                        child: CircularProgressIndicator(color: AppColors.goldStar, strokeWidth: 2))
                    : Text('Kirim',
                        style: TextStyle(fontSize: 15.sp, fontWeight: FontWeight.bold, color: AppColors.goldStar)),
              ),
            ),
