...
class LengkapiProfilViewModel extends ChangeNotifier {
  ...
  String? get whatsappError {
    ...
    if (v.isEmpty) return _submitAttempted ? 'Nomor WhatsApp wajib diisi' : null;
  ...
  Future<void> submit(BuildContext context) async {
    ...
    final payload = LengkapiProfilPayload(
      ...
      luasLahanHektar: luasLahanController.text.trim().isEmpty
          ? null
          : double.tryParse(luasLahanController.text.trim().replaceAll(',', '.')),
    ...
    try {
      ...
      _submitError = 'Gagal menyimpan profil. Coba lagi.';
      notifyListeners();
    }
  }
